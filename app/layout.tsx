      ...
      <div className="max-w-7xl mx-auto px-6 lg:px-8 py-16">
        ...
        <div className="grid grid-cols-1 lg:grid-cols-12 gap-x-12 gap-y-8 mb-12">
          ...
          <div className="lg:col-span-3 space-y-8">
            ...
            <Link href="/" className="inline-flex items-center space-x-3">
              <div className="w-12 h-12 deep-blue-gradient rounded-lg flex items-center justify-center">
            ...
            <ul className="space-y-3">
              <li><Link href="#" className="text-gray-700 hover:text-[#001F3F] transition-colors text-lg">Careers</Link></li>
              <li><Link href="#" className="text-gray-700 hover:text-[#001F3F] transition-colors text-lg">Alumni</Link></li>
              <li><Link href="#" className="text-gray-700 hover:text-[#001F3F] transition-colors text-lg">Global locations</Link></li>
            </ul>
          </div>
          ...
          <div className="lg:col-span-2">
            <ul className="space-y-3">
              <li><Link href="/about" className="text-gray-700 hover:text-[#001F3F] transition-colors text-lg">About us</Link></li>
              <li><Link href="/contact" className="text-gray-700 hover:text-[#001F3F] transition-colors text-lg">Contact us</Link></li>
            </ul>
          </div>
          ...
          <div className="lg:col-span-4">
            ...
            <div className="flex gap-3">
              <input 
                ...
                className="flex-1 px-4 py-3 border-2 border-gray-300 rounded-md focus:outline-none focus:border-[#001F3F] text-gray-900 bg-white text-base"
              />
              <button className="px-8 py-3 bg-blue-600 text-white font-semibold rounded-md hover:bg-blue-700 transition-colors whitespace-nowrap">
                Submit
              </button>
            </div>
          </div>
        ...
        <div className="flex flex-col lg:flex-row justify-between items-start lg:items-center gap-8">
          ...
          <div className="flex flex-wrap gap-x-6 gap-y-3 text-sm text-gray-600 justify-end">
            <Link href="#" className="hover:text-[#001F3F] transition-colors">Scam warning</Link>
            <Link href="#" className="hover:text-[#001F3F] transition-colors">FAQ</Link>
            <Link href="#" className="hover:text-[#001F3F] transition-colors">Privacy policy</Link>
            <button className="hover:text-[#001F3F] transition-colors flex items-center gap-2">
            ...
            <Link href="#" className="hover:text-[#001F3F] transition-colors">Cookie preferences</Link>
          </div>
        ...
        <div className="flex justify-end mt-4">
          <div className="flex flex-wrap gap-x-6 gap-y-3 text-sm text-gray-600">
            <Link href="#" className="hover:text-[#001F3F] transition-colors">Terms of use</Link>
            <Link href="#" className="hover:text-[#001F3F] transition-colors">Local language information</Link>
            <Link href="#" className="hover:text-[#001F3F] transition-colors">Accessibility statement</Link>
          </div>
        </div>
